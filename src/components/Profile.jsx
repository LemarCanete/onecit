...
const Profile = () => {
    ...
    return (
        <div className={`h-screen w-3/12 relative p-4 shadow-xl ${mode ? 'bg-slate-600 text-white' : 'bg-white'}`}>
            ...
            <div className="absolute bottom-0 left-0 flex justify-around w-full mb-2 text-2xl">
