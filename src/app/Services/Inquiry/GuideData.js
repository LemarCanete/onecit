const GuideData = [
    {
      ...
      options: [
        ...
        { label: 'Transfer credit evaluation', value: 'Transfer credit evaluation' },
      ],
    },
    {
      ...
      options: [
        ...
        { label: 'Loan inquiries', value: 'Loan inquiries' },
      ],
    },
    {
      ...
      options: [
        ...
        { label: 'Academic probation inquiries', value: 'Academic probation inquiries' },
      ],
    },
    {
      ...
      options: [
        ...
        { label: 'Health and wellness services', value: 'Health and wellness services' },
      ],
    },
    {
      ...
      options: [
        ...
        { label: 'Recreational facilities availability', value: 'Recreational facilities availability' },
      ],
    },
    {
      header: 'IT Support',
      email: 'tsg@cit.edu',
      options: [
        { label: 'Technical assistance with campus systems (e.g., email, learning management system)', value: 'Technical assistance with campus systems (e.g., email, learning management system)' },
        { label: 'WiFi connectivity issues', value: 'WiFi connectivity issues' },
        { label: 'Software installation support', value: 'Software installation support' },
      ],
    },
    {
      ...
      options: [
        ...
        { label: 'Interlibrary loan requests', value: 'Interlibrary loan requests' },
      ],
    },
    {
      ...
      options: [
        ...
        { label: 'Career counseling appointments', value: 'Career counseling appointments' },
      ],
    },
    {
      ...
      options: [
        ...
        { label: 'Name or address change requests', value: 'Name or address change requests' },
      ],
    },
    {
