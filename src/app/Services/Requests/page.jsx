  ...
  return (
    <div className="w-full h-screen flex bg-neutral-100">
      ...
      {/* <div className='"grow px-10 py-5'>
        <h1 className="text-2xl">Request Form</h1>
      </div> */}
      <form>
      <div className="space-y-5 grow px-10 py-5">
        <div className="border-b border-gray-900/10 pb-12">
        <h2 className="text-3xl font-semibold leading-7 text-gray-900">Request Form</h2>
          <div className="mt-10 grid grid-cols-1 gap-x-10 gap-y-10 sm:grid-cols-6">
            ...
            <div className="sm:col-span-6">
              <label htmlFor="idNumber" className="block text-lg font-medium leading-6 text-gray-900">
                ID number
              </label>
              <div className="mt-2">
                <input
            ...
            <div className="sm:col-span-full">
              <label htmlFor="emailAddress" className="block text-lg font-medium leading-6 text-gray-900">
                Email address
              </label>
              <div className="mt-2">
                <input
            ...
            <div className="col-span-full">
              <label htmlFor="program" className="block text-lg font-medium leading-6 text-gray-900">
            ...
            <div className="sm:col-span-2 sm:col-start-1">
              <label htmlFor="year-level" className="block text-lg font-medium leading-6 text-gray-900">
                Year Level
              </label>
              <div className="mt-2">
                <select
    ...
    <div className="space-y-5 grow px-10 py-5">
      <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-xl font-semibold leading-7 text-gray-900 mt-12 space-y-12">Which of the following documents are you requesting for a copy?</h2>
          <div className="mt-5 space-y-6">
              ...
              <div className="mt-1 space-y-3">
                <div className="relative flex gap-x-3">
                  ...
                  <div className="text-sm leading-6">
                    <label htmlFor="comments" className="text-lg font-medium text-gray-900">
                ...
                <div className="relative flex gap-x-3">
                  ...
                  <div className="text-sm leading-6">
                    <label htmlFor="candidates" className="text-lg font-medium text-gray-900">
                ...
                <div className="relative flex gap-x-3">
                  ...
                  <div className="text-sm leading-6">
                    <label htmlFor="certificates" className="text-lg font-medium text-gray-900">
                    Diploma
                    </label>
                  </div>
                </div>
                ...
                <div className="relative flex gap-x-3">
                  ...
                  <div className="text-sm leading-6">
                    <label htmlFor="others" className="text-lg font-medium text-gray-900">
                    Other: </label>
                    <div className="mt-2">
                <input
                  type="text"
            ...
            <fieldset>
              <legend className="text-base font-semibold leading-7 text-gray-900 mt-12 space-y-12">Number of Copies</legend>
              <div className="sm:col-span-2 sm:col-start-1">
              <div className="mt-3">
                <select
                  id="numberOfCopies"
            ...
            <legend className="text-base font-semibold leading-7 text-gray-900 mt-12 space-y-12">What is the purpose of the request?</legend>
            <div className="mt-1">
            <input
                  type="text"
                  name="program"
